*****************************************************
Unified Language Interface module
...
ULI provides a block similar to that provided by the core local module, however differs from the local block in several subtle ways:
